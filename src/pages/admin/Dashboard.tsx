...
import { Music, Image, FileText, LogOut, Settings, Volume2 } from "lucide-react";
    ...
    <main className="min-h-screen bg-background pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Link to="/admin/soundfonts">
            <Card className="p-6 hover:shadow-xl transition-all hover:-translate-y-1 bg-card/50 backdrop-blur cursor-pointer">
              <Volume2 className="h-12 w-12 text-primary mb-4" />
              <h2 className="text-2xl font-bold mb-2">Soundfont Manager</h2>
              <p className="text-muted-foreground">Upload and manage soundfont files for Guitar Pro</p>
            </Card>
          </Link>
